...
//         <div
//           key={idx}
//           className="rounded-2xl bg-translucent-light-4 border-[2px] border-translucent-light-4 p-4 grid gap-4 min-w-[300px]"
//         >
//           <div className="grid gap-6 p-2">
//             <span className="h-[64px] w-[64px] p-4 border-2 border-translucent-light-8 bg-translucent-light-8 rounded-2xl">
//               <Image
//                 src={option.icon}
...
//           <Button
//             variant="secondary"
//             className="h-12 px-5 py-3 rounded-[8px] bg-light-primary text-dark-primary"
//           >
//             Choose
//           </Button>
//         </div>
